...
param aiFoundryProjectName string = 'ai-marketing-${environmentName}'

@description('Name of the products vector index')
param productsIndexName string = 'products'

@description('Name of the personas vector index')
param personasIndexName string = 'personas'

@description('Name of the innovations vector index')
param innovationsIndexName string = 'innovations'
...
param aiProjectDeploymentsJson string = '[{"name":"gpt-5.4-mini","model":{"name":"gpt-5.4-mini","format":"OpenAI","version":"2026-03-17"},"sku":{"name":"GlobalStandard","capacity":1000}},{"name":"text-embedding-3-small","model":{"name":"text-embedding-3-small","format":"OpenAI","version":"1"},"sku":{"name":"GlobalStandard","capacity":300}}]'
...
output AZURE_SEARCH_PRODUCTS_INDEX_NAME string = productsIndexName
output AZURE_SEARCH_PERSONAS_INDEX_NAME string = personasIndexName
output AZURE_SEARCH_INNOVATIONS_INDEX_NAME string = innovationsIndexName
