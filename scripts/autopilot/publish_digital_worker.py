...
def publish_digital_worker(
    ...
    body = {
        ...
        "appVersion": "1.0.0",
        "shortDescription": "Campaign-driving A365 agent deployed via the autopilot pipeline.",
        "fullDescription": (
            "A NorthStar Health marketing digital worker that drives margin-aware "
            "campaigns and reports on their performance, grounded in the product, "
            "market-insights and persona data, and delivered through Microsoft 365."
        ),
        "developerName": "NorthStar Health",
