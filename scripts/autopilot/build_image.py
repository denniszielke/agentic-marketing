...
tenant, Azure OpenAI endpoint, model deployment and NorthStar Health marketing
toolbox endpoint are passed as build args so they are baked into the image's
environment (matching the sample).
